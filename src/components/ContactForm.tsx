...
export default function ContactForm({ propertyId, propertyTitle }: ContactFormProps) {
    ...
    return (
      <div className="card p-[var(--spacing-xl)] text-center">
        ...
        <button
          ...
          className="text-primary hover:text-primary-dark  :text-white font-medium focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-md px-2 py-1 transition-colors"
        >
  ...
  return (
    <div className="card p-[var(--spacing-xl)] sticky top-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-[var(--spacing-md)]">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-[var(--background)] border border-gray-300  rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-[var(--text-scale-base)] text-[var(--foreground)] transition-all shadow-xs"
            placeholder="..."
          />
          {errors.name && (
        ...
        {/* Email */}
        <div>
          <label htmlFor="email" className="block text-[var(--text-scale-sm)] font-medium text-[var(--foreground)] opacity-90 mb-1">
        ...
        {/* Phone */}
        <div>
          <label htmlFor="phone" className="block text-[var(--text-scale-sm)] font-medium text-[var(--foreground)] opacity-90 mb-1">
        ...
        {/* Message */}
        <div>
          <label htmlFor="message" className="block text-[var(--text-scale-sm)] font-medium text-[var(--foreground)] opacity-90 mb-1">
            {t('formMessageLabel')}
          </label>
          <textarea
            id="message"
            ...
            className="w-full px-4 py-3 bg-[var(--background)] border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent resize-vertical text-[var(--text-scale-base)] text-[var(--foreground)] transition-all shadow-xs"
            placeholder="..."
          />
          {errors.message && (
        ...
        {submitError && (
          <div className="p-3 bg-red-50 border border-red-200 rounded-md">
            <p className="text-red-600 text-[var(--text-scale-sm)]">{submitError}</p>
          </div>
        )}
      ...
      {/* Agent Info */}
      <div className="mt-[var(--spacing-xl)] pt-[var(--spacing-md)] border-t border-gray-200 ">
        <h4 className="font-semibold text-[var(--foreground)] mb-3">{t('contactInfo')}</h4>
        <div className="text-[var(--text-scale-sm)] text-[var(--foreground)] opacity-80 space-y-2">
