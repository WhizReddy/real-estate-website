        ...
        <div className="flex justify-between items-center h-18">
          ...
          <Link href="/" className="flex items-center space-x-3 py-2 group">
            <div className="relative">
              <div className="p-2 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-gray-500 text-xs font-medium">Premium Properties • {new Date().getFullYear()}</p>
            </div>
          </Link>
          ...
          <div className="md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-3 rounded-lg text-gray-600 hover:text-blue-700 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 touch-manipulation min-h-[44px] min-w-[44px]"
