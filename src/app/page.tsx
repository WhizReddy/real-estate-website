  ...
  return (
    <Layout variant="homepage">
      ...
      <div className="w-full relative bg-white">
        ...
        <section id="contact" className="bg-slate-900 py-20 text-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white rounded-3xl p-8 text-slate-900 shadow-2xl relative">
                <div className="absolute -top-6 -right-6 w-24 h-24 bg-blue-600 rounded-full opacity-10 animate-pulse" />
                <h3 className="text-xl font-bold mb-4">Më shumë informacion</h3>
                <p className="text-slate-600 mb-6 text-sm">
                  Na tregoni se çfarë po kërkoni dhe ne do t&apos;ju kontaktojmë me ofertat më të mira.
                </p>
                <Link
                  href="/contact"
                  className="w-full py-4 bg-blue-600 text-white rounded-xl font-bold text-center block transition-transform hover:scale-[1.02]"
                >
                  Dërgo Mesazh
                </Link>
              </div>
