        ...
        <div className="max-w-md w-full text-center">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mb-8">
              Na vjen keq, por pasuria që po kërkoni nuk ekziston, është shitur, ose është hequr nga lista.
            </p>
          </div>
          ...
          <div className="mt-8 text-sm text-gray-500">
            <p>Mund të kërkoni pasuri të ngjashme ose të kontaktoni me agjentin tonë për ndihmë.</p>
          </div>
        </div>
      </div>
    </Layout>
